...
MyConnection = MySQLdb.connect( host = "localhost", user = "python_user", \
                                passwd = "monty", db = "midwater")
...
for Index in range(SQLLen):
	# two dimensional indexing: [row][col] - remember py starts numbering at 0
